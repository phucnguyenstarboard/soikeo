        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                spacer.html('<div class="spacer-bottom">'
                    +'<div class=" name">Type Of Work<br>Standard Name</div>'
                    +'<div class=" desc">Work Schedule</div>'
                    +'<div class=" desc2">Quantity</div>'
                    +'<div class=" desc3">Percentage Of Progress(%)</div>'
                    +'</div>'
                    )
