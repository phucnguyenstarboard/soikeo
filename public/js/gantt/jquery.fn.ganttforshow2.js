    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            leftPanel: function (element) {
                /* Left panel */
                let spacer = $('<div class="row spacer header '+ settings.scale +'"/>');
                spacer.html('<div class="spacer-bottom">'
                    +'<div class=" name">労務費マスタ<br>コード</div>'
                    +'<div class=" name1" style=" font-weight: bold;">外注費マスタ<br>コード</div>'
                    +'<div class=" desc" style="width:30%;">労務種別名・規格</div>'
                    +'<div class=" desc1" style="font-weight: bold;">外注種別名・規格</div>'
                    +'<div class=" desc2">数量</div>'
                    +'<div class=" desc3">作業予定</div>'
                    +'<div class=" desc4">外注先</div>'
                    +'</div>'
                    )
                ...
                case 'months':
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        monthArr.push(
                            ...
                            '" data-offset="' + i * tools.getCellSize() +
                            '" data-repdate="' + rday.getRepDate(settings.scale) + '"><div class="fn-label">' +
                            (1 + rday.getMonth()) + '</div></div>');
                    }
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "weeks":
                                ...
                                topEl = $(element).find("#rowheader" + i);
                                var top1 = (i+1) * 48- 44;
                                top = cellWidth * 3 + barOffset + top1;
                                _bar.css({
                                  top: top,
                                  left: Math.floor(cFrom),
                                  width: dp + '%'
                            ...
                            case "months":
                                ...
                                topEl = $(element).find("#rowheader" + i);
                                var top1 = (i+1) * 48- 44;
                                top = cellWidth * 2 + barOffset + top1;
                                _bar.css({
                                  top: top,
                                  left: Math.floor(cFrom),
                                  width: dp + '%'
                            ...
                            default:
                                ...
                                topEl = $(element).find("#rowheader" + i);
                                var top1 = (i+1) * 48- 44;
                                top = cellWidth * 4 + barOffset + top1;
                                _bar.css({
                                  top: top,
                                  left: Math.floor(cFrom),
                                  width: dp + '%'
