...
?>
        <div class="main-content">
            <?php get_template_part( 'template-parts/bootstrap_container', get_post_type() );?>
                ...
                <input type="hidden" id="rowNo" value="502325205" />
                ...
                <div class="row">
                            ...
                            <div class="col-sm-7 col-md-7">
                                ...
                                <div class="row">
                                    <div class="panel-item">
                                        <div class="title">
                                            <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png">&nbsp;&nbsp;本场预测</span>
                                        </div>
                                        <div class="cont">
                                            <div class="subList">
                                ...
                                <div class="row">
                                    <div class="panel-item">
                                        <div class="title">
                                            <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png">&nbsp;&nbsp;本场重要提示</span>
                                        </div>
                                        <div class="cont">
                    ...
                    <div class="col-sm-4 col-md-4 column" style="padding:0px;" id="leftIfnoDiv">
                        ...
                        <div class="panel-item" id="skDiv">
                            <div class="title">
                                <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png" >&nbsp;&nbsp;赛况</span>
                        ...
                        <div class="panel-item" id="zjDiv">
                            <div class="title">
                                <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png" >&nbsp;&nbsp;双方近期战绩</span>
                        ...
                        <div class="panel-item" id="pvDiv">
                            <div class="title">
                                <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png" >&nbsp;&nbsp;本场即时赔率 </span>
                        ...
                        <div class="panel-item"  id="djDiv">
                            <div class="title">
                                <span class="pull-left"><img src="<?php bloginfo('template_directory');?>/assets/images/zuqiu.png" >&nbsp;&nbsp;独家数据</span>
...
<script type="text/javascript" src="<?php bloginfo('template_directory');?>/assets/js/echarts-all.js"></script>
