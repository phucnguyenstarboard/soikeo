...
@section('title')
<title>Danh sách ngân hàng - ADMIN</title>
@endsection
@section('content')
    <h3 class="text-center" style="font-weight: 700;">Danh sách ngân hàng</h3>
    <!-- list -->
    <a style="color: #fff;" href="{{ route('admin_banks_add') }}" class="btn btn-primary mb-2">Thêm mới</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-confirm-2', function() {
                ...
                var m = 'Bạn muốn xóa ngân hàng [ ' + $(this).attr('data-name') + ' ] ?';
                Swal.fire({
                    title: 'Xác nhận',
                    html: m,
                    type: '',
