                        ...
                        <table class="table table-striped table-bordered t2-datatable" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><button {{ $item->is_delete == 1 ? 'disabled' :  '' }} data-id="{{ $item->id }}" data-name="{{ $item->bank_name }}" type="button" class="btn-confirm-2 btn btn-danger">Xóa</button></td>
