...
@section('title')
<title>商品列表 - ADMIN</title>
@endsection
@section('content')
    <h3 class="text-center" style="font-weight: 700;">商品列表</h3>
    <!-- list -->
    <a style="color: #fff;" href="{{ route('admin_category_add') }}" class="btn btn-primary mb-2">添加商品</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-confirm-2', function() {
                ...
                var m = '您确定要删除该产品吗 [ ' + $(this).attr('data-name') + ' ] ?';
                Swal.fire({
                    title: '确认',
                    html: m,
                    type: '',
