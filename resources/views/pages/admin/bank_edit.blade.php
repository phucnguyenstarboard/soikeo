...
@section('title')
<title>Cập nhật ngân hàng - ADMIN</title>
@endsection
@section('page-style')
...
@endsection
@section('content')
    <h3 class="text-center" style="font-weight: 700;">Cập nhật ngân hàng</h3>

    <div class="card block-search">
        <div class="card-content">
            <div class="card-body mt-1">
                <div>
                    <form id="form-create" action="{{ route('admin_banks_update', ['id' => $product->id ]) }}" method="POST" enctype="multipart/form-data" novalidate="">
                        @csrf
                        
                        <div class="row">
                             <div class="col-12 col-sm-12 col-lg-12">
                                <label for="s-ordered_date_s">Tên ngân hàng</label>
                            ...
                            <div class="col-12 col-sm-3 col-lg-3">
                                ...
                                <fieldset class="form-group">
                                    <div class="form-check form-check-inline">
                                      ...
                                      <label class="form-check-label" for="inlineCheckbox1">Xóa ngân hàng</label>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
