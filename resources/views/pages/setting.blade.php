...
<body class="horizontal-layout horizontal-menu" data-open="click" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-4 profile">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6">
                                    <div class="card">
                                        <div class="card-body" style="margin-bottom: 0.45rem;">
                                            <h1><i class="fa fa-bank"></i> 设立银行账户</h1>
                                            <div class="form-group row mb-0 mt-2">
                                                <div class="col-12 col-sm-12">
                                                    <button type="button" class="btn btn-danger btn-show-modal"> <i class="fa fa-bank"></i> 更新帐户</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 style="color:#007bff">{{ $item->bank_name }}</h3>
                                            <h1>{{ $item->account_number }}</h1>
                                            <h4>银行账户名称: {{ $item->account_name }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <form id="form_back" action="{{ route('setting') }}" method="GET" style="display: none;"></form>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg create-project-id-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="projectModal">设立银行账户g</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('post_setting') }}" id="form-profile" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="This is required" type="text" name="account_name" maxlength="255" class="form-control" value="{{ $item->account_name }}">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="This is required" type="text" name="account_number" maxlength="255" class="form-control" value="{{ $item->account_number }}">
                                <div class="help-block"></div>
