...
<head>
    ...
    <title>GAO ADMIN - Cài đặt tài khoản ngân hàng</title>
    <!-- Fonts -->
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6">
                                    <div class="card">
                                        <div class="card-body" style="margin-bottom: 0.45rem;">
                                            <h1><i class="fa fa-bank"></i> Cài đặt tài khoản ngân hàng</h1>
                ...
                <div class="modal-body">
                    <form action="{{ route('post_setting') }}" id="form-profile" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập tên tài khoản" type="text" name="account_name" maxlength="255" class="form-control" value="{{ $item->account_name }}">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập số tài khoản" type="text" name="account_number" maxlength="255" class="form-control" value="{{ $item->account_number }}">
                                <div class="help-block"></div>
