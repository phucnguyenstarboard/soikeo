...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  menu-collapsed blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                                    ...
                                    <div class="card rounded-0 pb-1 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title text-center">
                                                <h2 class="mb-0">管理员登录</h2>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('post_login') }}" id="form-login" method="POST" novalidate>
                                                    @csrf
                                                    <div class="form-label-group form-group position-relative has-icon-left">
                                                        <div class="controls">
                                                            <input type="text" class="form-control" id="account" name="account" placeholder="账户名" required
                                                                data-validation-required-message="请输入账户名" maxlength="255"
                                                                value="">
                                                    ...
                                                    <div class="form-label-group form-group position-relative has-icon-left">
                                                        <div class="controls">
                                                            <input type="password" class="form-control" id="password" name="password" placeholder="密码" required
                                                                data-validation-required-message="请输入密码" maxlength="255"
                                                                value="">
                                                            <div class="help-block"></div>
                                                        </div>
                                                        <div class="form-control-position">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 mb-1">
                                                            <button style="width:100%" type="submit" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">登录</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
    ...
    <script>
        function initValidation() {
            if ($("#form-login").attr("novalidate") != undefined) {
                // Input, Select, Textarea validations except submit button
                $("#form-login").find("input,select,textarea").not("[type=submit]").jqBootstrapValidation({
