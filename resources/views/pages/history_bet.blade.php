                                        ...
                                        <div>
                                            <form id="form-search" action="{{ route('post_history_bet') }}" method="POST" novalidate="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-4 col-lg-3">
                                                        <label for="s-m_user_id">地位</label>
                                                        <fieldset class="">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg create-project-id-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="projectModal">更新投注结果</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('update_status_bet') }}" id="form-profile" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">会话代码</label>
                            <div class="col-8 col-sm-9">
                                <label class="col-form-label" id="thv"></label>
                            </div>
                        </div>
                             <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label"> 投注结果</label>
                            <div class="col-8 col-sm-9">
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">结果</label>
                            <div class="col-8 col-sm-9">
