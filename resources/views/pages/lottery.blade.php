...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/app.css') }}?v=1111">
    <!-- END: Custom CSS-->
</head>
<!-- BEGIN: Body-->
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-4 profile">
                            ...
                            <div class="card block-search">
                                ...
                                <div class="card-content collapse">
                                    <div class="card-body">
                                        <div>
                                            <form id="form-search" action="{{ route('post_lottery') }}" method="POST" novalidate="">
                                                @csrf
                                                <div class="row">
                            ...
                            <div id="search_result">
                                @include('pages.subpages.lottery_list',[
                                'data_list' => $item_session,
                                ])
                            </div>
