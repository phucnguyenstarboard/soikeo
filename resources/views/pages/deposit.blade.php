...
<body class="horizontal-layout horizontal-menu" data-open="click" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-4 profile block-bank">
                            ...
                            <div class="card block-search">
                                ...
                                <div class="card-content collapse">
                                    <div class="card-body">
                                        <div>
                                            <form id="form-search" action="{{ route('post_deposit') }}" method="POST" novalidate="">
                                                @csrf
                                                <div class="row">
                            ...
                            <div id="search_result">
                                @include('pages.subpages.deposit_list',[
                                'data_list' => $item_deposit,
                                'from' => $from,
                                'to' => $to
                                ])
                            </div>
    ...
    <form id="form_update" action="{{ route('confirm_deposit') }}" method="POST" style="display: none;">
        <input type="hidden" id="hdId" name="id_deposit" value="">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-confirm', function() {
                ...
                var m = 'Bạn có chắc muốn xoá giao dịch này? Điều này không thể khôi phục.';

                if (status == 1) {
                    m = 'Bạn có chắc muốn duyệt giao dịch này ?';
                } else if (status == 2) {
                    m = 'Bạn có chắc muốn từ chối giao dịch này ?';
                }
