...
<head>
    ...
    <title>GAO ADMIN - Quản lý đặt cược</title>
    <!-- Fonts -->
                                            ...
                                            <form id="form-search" action="{{ route('user_search') }}" method="POST" novalidate="">
                                                ...
                                                <div class="row">                                                    
                                                    <div class="col-12 col-sm-4 col-lg-3">
                                                        <label for="s-ordered_date_s">Tên tài khoản</label>
                    ...
                    <form action="{{ route('user_profile') }}" id="form-profile" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập tên người dùng" type="text" id="username" name="username" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập tên tài khoản" type="text" id="account" name="account" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('user_password') }}" id="form-profile-2" method="POST" novalidate>
                        ...
                        <input type="hidden" class="hdId" value="0" name="user_id" />
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">Mật khẩu mới</label>
                            <div class="col-8 col-sm-9">
                                <div class="input-group" id="show_hide_password">
                                    <input required="" data-validation-required-message="Vui lòng nhập mật khẩu" type="password" name="password" maxlength="255" class="form-control" value="" aria-invalid="false">
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">Xác nhận mật khẩu</label>
                            <div class="col-8 col-sm-9">
                                <div class="input-group" id="show_hide_password_2">
                                    <input required="" data-validation-required-message="Vui lòng nhập xác nhận mật khẩu" type="password" name="password_confirm" maxlength="255" class="form-control" value="" aria-invalid="false">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary waves-effect waves-light" type="button"><i class="fa fa-eye-slash dark"></i></button>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('user_fun_pass') }}" id="form-profile-3" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <div class="input-group" id="show_hide_password">
                                    <input required="" data-validation-required-message="Vui lòng nhập mật khẩu" type="password" name="fund_password" maxlength="255" class="form-control" value="" aria-invalid="false">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary waves-effect waves-light" type="button"><i class="fa fa-eye-slash dark"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <div class="input-group" id="show_hide_password_2">
                                    <input required="" data-validation-required-message="Vui lòng nhập xác nhận mật khẩu" type="password" name="fund_password_confirm" maxlength="255" class="form-control" value="" aria-invalid="false">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary waves-effect waves-light" type="button"><i class="fa fa-eye-slash dark"></i></button>
                                    </div>
                                </div>
                    ...
                    <form action="{{ route('user_balance') }}" id="form-profile-4" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                ...
                                <input required="" data-validation-required-message="Vui lòng nhập số dư" type="number" name="balance" maxlength="255" class="form-control" value="" aria-invalid="false">
                    ...
                    <form action="{{ route('user_prize') }}" id="form-profile-5" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                ...
                                <input required="" data-validation-required-message="Vui lòng nhập số dư" type="number" name="prize_amount" maxlength="255" class="form-control" value="" aria-invalid="false">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-confirm-2', function() {
                ...
                if (status == 1) {
                    ...
                    $("#projectModal").html('Chỉnh sửa thông tin cho : ' + $(this).attr('data-account'));
                    $("#username").val($(this).attr('data-username'));
                    $("#account").val($(this).attr('data-account'));

                } else if (status == 2) {
                    $('#create-project-id-modal2').modal('show');
                    $("#projectModal2").html('Thiết lập mật khẩu mới cho : ' + $(this).attr('data-account'));
                } else if (status == 3) {
                    $('#create-project-id-modal3').modal('show');
                    $("#projectModal3").html('Thiết lập mật khẩu quỹ mới cho : ' + $(this).attr('data-account'));
                } else if (status == 4) {
                    $('#create-project-id-modal4').modal('show');
                    $("#projectModal4").html('Nhập số dư mới cho : ' + $(this).attr('data-account'));
                } else if (status == 6) {
                    $('#create-project-id-modal5').modal('show');
                    $("#projectModal5").html('Nhập tiền thưởng cho : ' + $(this).attr('data-account'));
                } else if (status == 5) {

                    var m = 'Bạn có chắc chắn muốn xoá thành viên [ ' + $(this).attr('data-account') + ' ] ?';
                    Swal.fire({
                        ...
                        if (result['dismiss'] === undefined) {
                            updateData($('#form_update'), false, function(data) {
                                Swal.fire({
                                    title: '',
                                    html: 'Đã xoá thành khoản thành viên thành công.',
                                    type: 'success',
