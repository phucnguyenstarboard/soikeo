                                        ...
                                        <div>
                                            <form id="form-search" action="{{ route('post_bank') }}" method="POST" novalidate="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-4 col-lg-3">
                                                        <label for="s-ordered_date_s">银行帐号</label>
                                                        <fieldset class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('update_bank') }}" id="form-profile" method="POST" novalidate>
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">银行名称</label>
                            <div class="col-8 col-sm-9">
                                <select required
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">银行分行</label>
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="This is required" type="text" id="branch" name="branch" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">银行账户名称</label>
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="This is required" type="text" id="account_name" name="account_name" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-2">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">银行帐号</label>
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="This is required" type="text" id="account_number" name="account_number" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-show-modal', function() {
                ...
                $("#projectModal").html('更新银行账户 : ' + $(this).attr('data-account'));
