...
<head>
    ...
    <title>GAO ADMIN - Quản lý bank</title>
    <!-- Fonts -->
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-4 profile block-bank">
                            ...
                            <div class="card block-search">
                                ...
                                <div class="card-content collapse">
                                    <div class="card-body">
                                        <div>
                                            <form id="form-search" action="{{ route('post_bank') }}" method="POST" novalidate="">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-12 col-sm-4 col-lg-3">
                                                        <label for="s-ordered_date_s">Tên tài khoản</label>
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control" value="" name="s-username">
                                                            <div class="help-block"></div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-12 col-sm-4 col-lg-3">
                                                        <label for="s-ordered_date_s">Số tài khoản ngân hàng</label>
                                                        <fieldset class="form-group">
                                                            <input type="text" class="form-control" value="" name="s-account-number">
                                                            <div class="help-block"></div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="col-12 col-sm-4 col-lg-3">
                            ...
                            <div id="search_result">
                                @include('pages.subpages.bank_list',[
                                'data_list' => $item_bank,
                                ])
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg create-project-id-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('update_bank') }}" id="form-profile" method="POST" novalidate>
                        @csrf
                        <input type="hidden" id="hdId" value="0" name="user_id" />
                        <div class="form-group row mb-0">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">Tài khoản hội viên</label>
                            <div class="col-8 col-sm-9">
                                <label class="col-form-label" id="tkhv"></label>
                            </div>
                        </div>
                        <div class="form-group row mb-1">
                            <label for="staticEmail" class="col-4 col-sm-3 col-form-label">Tên hội viên</label>
                            <div class="col-8 col-sm-9">
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập chi nhánh" type="text" id="branch" name="branch" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập tên tài khoản" type="text" id="account_name" name="account_name" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-8 col-sm-9">
                                <input required
                                    data-validation-required-message="Vui lòng nhập số tài khoản" type="text" id="account_number" name="account_number" maxlength="255" class="form-control" value="">
                                <div class="help-block"></div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-show-modal', function() {
                ...
                $("#projectModal").html('Cập nhật tài khoản ngân hàng cho : ' + $(this).attr('data-account'));
                $("#hdId").val($(this).attr('data-id'));
                $("#tkhv").html($(this).attr('data-account'));
                $("#thv").html($(this).attr('data-username'));
                $("#cbxBank").val($(this).attr('data-bankname'));
                $("#branch").val($(this).attr('data-branch'));
                $("#account_name").val($(this).attr('data-accountname'));
                $("#account_number").val($(this).attr('data-accountnumber'));
            });
        });
