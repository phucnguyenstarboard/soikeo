...
<head>
    ...
    <title>GAO ADMIN - Trang chủ</title>
    <!-- Fonts -->
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-4 profile">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4>Phiên hiện tại : <span class="session_id">{{ $item->session_id }}</span></h4>
                                            ...
                                            <h4>Phiên kế tiếp : <span class="session_id_next">{{ $item->session_id + 1 }}</span></h4>
                                            <h4 class="mt-2">Thời gian đến phiên kế tiếp</h4>
                                            ...
                                            <h4 class="mt-2">Chỉnh kết quả phiên kế tiếp</h4>
