...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $data_list = DB::table('category_vn as category')
    ...
    public function insert(Request $request)
    {
        ...
        DB::table('category_vn')->insert($dataInsert);
    ...
    {
        $user = Auth::user();
        $product = DB::table('category_vn as category')
    ...
    public function update(Request $request, $id)
    {
        ...
        $article = DB::table('category_vn as category')
            ->select('category.*')->where('category.id', $id)->first();
        ...
        DB::table('category_vn')->where('id', $id)->update($dataInsert);
    ...
    public function delete(Request $request)
    {
        ...
        DB::table('category_vn')->where('id', $data['cat_id'])->update($dataUpdate);
